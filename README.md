...
* В **Ubuntu** так же нужно установить Cerebro и `xdotool` (`sudo apt install xdotool`) и добавить [вот такой ярлык](./cerebro-lin/cerebro.desktop) на рабочий стол и сделать исполняемым в его настройках (ярлык так же эмулирует нажатие hotkey). Помимо этого, нужно будет компактно спрятать ярлыки на рабочем столе с помощью `gnome-pie`. В нем нужно будет настроить раздел закладок - удалить существующие категории из него, и добавить ярлыки на сайты. Потом нужно добавить ярлык раздела закладок на рабочий стол. Там же можно заменить и значок ярлыка на незаметный или пустой. 
